...
describe SpreeChimpy do

  context "enabled" do
    before do
      SpreeChimpy::Interface::List.stub(new: :list)
      SpreeChimpy::Interface::Orders.stub(new: :orders)
    ...
    specify "attributes of SpreeChimpy when configured" do
  ...
  context "disabled" do
    ...
    specify "attributes of SpreeChimpy when not configured" do
  ...
  context "sync merge vars" do
    ...
    before do
      SpreeChimpy::Interface::List.stub(new: interface)
      config(key: '1234',
             list_name: 'Members',
  ...
  def config(options = {})
    config = SpreeChimpy::Configuration.new
